...
## async / await: Promises con cara humana
...
Practica con `setTimeout` para sentirte cómodo con la asincronía antes de añadir la complejidad de la red. En la siguiente unidad usarás todo esto con `fetch` y APIs reales.
